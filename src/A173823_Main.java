...
public class A173823_Main {
	public ArrayList<Character> eng;
	public ArrayList<String> morse;
	public ArrayList<String> compare;
	public ArrayList<String> display;
	public int scan;
	
	public void MorseCode() {
		eng=new ArrayList<Character>();
		morse=new ArrayList<String>();
		try {
			Scanner sc=new Scanner(new File(System.getProperty("user.dir")+"\\src\\A173823_File2.dat"));
			while(sc.hasNext()) {
				String e=sc.next();
				char ch=e.charAt(0);
				String m=sc.next();
	...
	public void MorseDisplay() {
		...
		try {
			Scanner in=new Scanner(new File(System.getProperty("user.dir")+"\\src\\A173823_File2.dat"));
			while(in.hasNext()) {
			...
			System.out.println("Error");
			System.out.println(System.getProperty("user.dir")+"\\A173823_File2.dat");}
		
		A173823_MorseTree <String> tree = new A173823_MorseTree <String>();		
		for(int i=0; i<display.size(); i++) {
			tree.add(display.get(i), morse.get(i));
		}
		System.out.println();
		tree.inorder();
		System.out.println();
	...
	public static void main(String[] args) {
		A173823_Main mc=new A173823_Main();
		mc.MorseCode();
	}
}
